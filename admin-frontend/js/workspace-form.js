...
async function loadHubs() {
    try {
        const hubs = await fetch(`${API_URL}/hubs`).then(r => r.json());
...
async function loadWorkspace() {
    try {
        ...
        f.elements['base_price_per_hour'].value = w.base_price_per_hour || w.price_per_hour || '';
...
async function handleSubmit(e) {
    ...
    const body = {
        ...
        base_price_per_hour: parseFloat(data.base_price_per_hour),
